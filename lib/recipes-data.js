...
"red-velvet-cake": {
  ...
  "highlighted": true,
  "excerpt": "A perfect love cake to relish the feelings of love, care, warmth, affection, trust and confidence",
  "source": {
    "name": "My Makeup Smile",
    "url": "https://mymakeupsmile.wordpress.com/2016/02/04/red-velvet-cake-recipe-for-valentines-day/"
  },
  "cookTime": "25-30 min",
  "ingredients": [
    "2 1/2 cups all-purpose flour",
  ...
  "directions": [
    "Preheat oven to 350 degrees.  Grease and lightly flour 3 round 9″ cake pans.",
...
"strawberry-cupcakes": {
  ...
  "highlighted": true,
  "excerpt": "Strawberry cupcake is one of my favorites.",
  "source": {
    "name": "Sprinkle Bakes",
    "url": "http://www.sprinklebakes.com/2015/05/large-batch-strawberry-cupcakes.html"
  },
  ...
  "directions": [
    ...
    "Whisk together the first 4 ingredients in a large mixing bowl. In a separate bowl, stir together the sour cream, water, eggs and extract.",
    ...
    "Transfer the cakes to a wire rack to cool completely. When the cakes are cool, cut a divot in the tops of the cakes using a serrated knife.",
    "Discard the cut-out, or save it for an ice cream sundae topping. Fill each cooled cupcake with strawberry jam."
  ],
